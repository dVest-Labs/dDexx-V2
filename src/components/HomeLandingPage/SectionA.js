      ...
      <Container className={classes.container}>
        <div className={classes.headerGridSection}>
          <Grid container direction="column" justifyContent="center" alignItems="center" className={classes.headerGrid}>
            ...
            <Typography variant="body1" className={classes.subText}>An all-in-one decentralized finance ecosystem built
              by the people for the people for financial freedom</Typography>
          </Grid>
        </div>

        <Grid container direction="column" justifyContent="center" alignItems="center" className={classes.btnGroup}
              spacing={0}>
